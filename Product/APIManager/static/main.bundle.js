...
var DataHandlerService = (function () {
    function DataHandlerService(http) {
        this.http = http;
        this.ROOT_URL = 'http://localhost:8000/api/v1/recommendations';
    }
