...
def test_retrieve_watched_and_not_watched():
    ...
    observed = RetrieveRecommendation().retrieve_watched_and_not_watched()
    observed_watched = observed[0]
    observed_not_watched = observed[1]
